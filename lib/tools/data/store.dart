import 'package:im_voice_demo/tools/data/notice.dart';
import 'package:flutter/material.dart';
import 'dart:async';
import 'package:shared_preferences/shared_preferences.dart';

typedef StoreBuilder<T> = Widget Function(T item);
...
class CacheWidget<T> extends StatefulWidget {
  ...
  const CacheWidget(this.action, this.builder, {Key? key,this.data}) : super(key: key);

  @override
  _CacheWidgetState createState() => _CacheWidgetState<T>();
}
...
class _CacheWidgetState<T> extends State<CacheWidget<T>> with BusStateMixin {
  ...
  @override
  void didUpdateWidget(covariant CacheWidget<T> oldWidget) {
